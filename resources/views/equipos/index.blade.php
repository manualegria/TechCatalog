    ...
    <section class="equipo dashboard">
        ...
        <div class="card">
            ...
            <div class="card-header py-3">
                <div class="row">
                    <h3 class="m-0 font-weight-bold text-primary col-md-11">Equipos</h3>
                    <div class="col-md-1">
                        <a href="{{ route('equipos.create') }}" class="btn btn-primary"><i
            ...
            <div class="card-body">
                ...
                <form class="navbar-search" method="GET" action="{{ route('equipos.index')}}" >
                    ...
                    <tbody>
                        @foreach ($equipos as $equipo)
                            <tr>
                                ...
                                <a href="{{ route('equipos.show', $equipo->id) }}" class="btn btn-sm btn-info"><i 
                                class="bi bi-eye-fill"></i></a>

                                    <a href="{{ route('equipos.edit', $equipo->id) }}" class="btn btn-sm btn-warning"><i
                                            class="bi bi-pencil-fill"></i></a>


                                    <form action="{{ route('equipos.delete', $equipo->id) }}" style="display:contents" method="POST">
                                        @csrf
                                        @method('DELETE')
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination justify-content-center">
                        ...
                        {{ $equipos->appends(request()->except('page'))->links('vendor.pagination.custom') }}
